  ...
  return (
    <div className="flex items-center w-11/12 justify-center">
        ...
        <div className="flex flex-col ml-5">
          <div className="flex items-center">
            <p
              ...
              onClick={() => router.push(`/user/${following.id}`)}
            >
              {following.name}
            </p>
            {following.isVerified && <MdVerified className="text-blue-500  md:ml-2" />}
          </div>
      ...
      <div className="hidden md:block">
        <button
          className="rounded-full hover:text-red-500 border-2 border-gray-400 bg-white mx-2 p-2
           text-lg text-gray-600"
          onClick={unFollow}
          onMouseOver={() => setfollowing("UnFollow")}
          onMouseOut={() => setfollowing("Following")}
        >
          {follow}
        </button>
      </div>
