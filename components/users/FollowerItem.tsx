...
const FollowerItem = ({ follower }: IProps) => {
  ...
  return (
    <div className="flex w-full items-center">
      <div className="flex  sm:w-auto lg:w-full    items-center p-5">
        ...
        <div className="flex flex-col ml-5">
          <div className="flex items-center">
            ...
            {follower.isVerified && <MdVerified className="text-blue-500 md:ml-2" />}
          </div>
      ...
      <div className="hidden md:block">
        <button
          className={`rounded-full w-full border-2 border-gray-400 
          ${isFollowing ? "bg-white" : " bg-black text-white"} mx-2 p-2 text-lg font-bold'  `}
          onClick={handleClick}
        >
