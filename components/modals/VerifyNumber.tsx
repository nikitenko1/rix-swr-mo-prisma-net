    ...
    <div className="flex flex-col gap-3">
      <div className="flex gap-2">
        <input
          ...
          className="border border-gray-300 w-1/2 p-2 rounded-md outline-none "
        />
        <button className="bg-blue-500 text-white p-2 rounded-md" onClick={generateOTP}>
          Send OTP
        </button>
      </div>
      <div className="flex gap-2 mt-5 ">
        <input
          type="text"
          placeholder="1"
          className="border border-gray-300 w-1/12 p-2 rounded-md outline-none"
        />
        <input
          type="text"
          placeholder="2"
